...
狀態：**已合併部署 v11.63**（合併授權有原文出處，見下）
> **T433 2026-08-14 校正**：本行原本停在 `STOP: READY_TO_MERGE`（等待業主合併指示），與「它已在 v11.63 落地」不同步。
> 授權出處：`docs/CHANGELOG.md` 的 T427 條目**驗收欄**逐字寫著
> 「業主 2026-08-11 明示『427出卡並施工完成』**後再明示『合并吧』授權本卡合併部署**」。
> 同一行的**說明欄**寫的是**出卡當下**的狀態（「本卡未授權合併，完成後停 READY_TO_MERGE」），兩者不衝突：
> 一個記發卡時、一個記放行後。
>
> **本行改過三次，過程留痕（這比結論重要）**：
> ① R01 我寫「業主其後明示放行」——結論對，但當時我沒引出處。
> ② R02 對抗性覆核的懷疑者報 blocker 說這句查無出處，**我沒有自己複驗就照做**，
>    把它改成「合併授權在倉庫內查無記錄」——**那是一句反方向的假話**。
> ③ R03 裁決者複驗判該 blocker 為假陽性（懷疑者只讀了說明欄、沒讀驗收欄），我親自打開 CHANGELOG 確認，撤回 ②。
>
> **我的錯不是 ①，是 ②：拿到一條 blocker 就改，沒有先自己去看一眼。**
> 「不可把判斷掛在業主名下」和「不可因為別人說查無出處就抹掉一筆真實授權」是同一條紀律的兩面：
> **兩邊都要以原文為準。**
發卡／施工：DeepSeek（業主 2026-08-11 明示「427出卡並施工完成」——本卡授權出卡＋施工；**合併未授權**，完成後停 READY_TO_MERGE，合併待業主指示）　※T433：此行**維持原文不動**——它忠實記錄了**出卡當下**的授權狀態；其後的放行原話在 CHANGELOG 該卡條目的驗收欄。不改寫歷史。
