...
runPwaTests().then(() => {
  ...
  { // ===== T421 ART-LOOP 守衛（獨立受管區；訊息只具名 T421） =====
    ...
    assert(m421['15_1_1']&&m421['15_1_1'].w===72&&m421['15_1_1'].h===112&&m421['15_1_1'].ax===36&&m421['15_1_1'].ay===110
      ...
      'T421 G2 metadata 恆等：15_1_1..4 record w72/h112/ax36/ay110');
    const wl421=['15_1_1','15_1_2','15_1_3','15_1_4'];
    ...
    // 每鍵 ink=16+8+8+7+5+5=49；四鍵
    assert(rp421['15_1_1'].ops>=6&&rp421['15_1_2'].ops>=6&&rp421['15_1_3'].ops>=6&&rp421['15_1_4'].ops>=6
      &&rp421['15_1_1'].ink>=49&&rp421['15_1_2'].ink>=49&&rp421['15_1_3'].ink>=49&&rp421['15_1_4'].ink>=49,
      'T421 G3 落筆觀測：15_1_1..4 ops≥6 ink≥49，實得 '+JSON.stringify({a:rp421['15_1_1'].ops+':'+rp421['15_1_1'].ink,b:rp421['15_1_2'].ops+':'+rp421['15_1_2'].ink,c:rp421['15_1_3'].ops+':'+rp421['15_1_3'].ink,d:rp421['15_1_4'].ops+':'+rp421['15_1_4'].ink}));
    // G4 beacon：art_diff 量測「重點細節色」全量貼上（每鍵各自；禁手打漏列）
    const beacon421={};
    // 15_1_1／15_1_2 同構（R01 BASE 量測）
    const acc12=[
    ...
    // 15_1_3（紅系；#161d2f 在 31,98／40,99；無 #ffffff≤16——白徽×48）
    const acc13=[
      '26,106','27,106','28,106','29,106','32,106','33,106','34,106','35,106','38,106','39,106','40,106','41,106','44,106','45,106','46,106','47,106',
      '10,90','61,90','8,91','9,91','62,91','63,91','6,92','7,92','64,92','65,92','4,93','5,93','66,93','67,93',
      '28,104','29,104','30,104','31,104','32,104','28,105','29,105','30,105','31,105','32,105','30,106','31,106',
      ...
      '17,88','54,89','24,92','47,92','31,95','40,96',
      '17,91','54,92','24,95','47,95','31,98','40,99',
      '22,101','23,101','24,101','46,101','47,101','48,101',
      '17,95','18,95','25,99','31,102','32,102',
      '52,96','45,99','46,99','38,103',
      '36,105','36,106','36,107',
      '10,93','37,108','61,93'
    ];
    // 15_1_4（灰藍；#b8bfc8@38-41,99；#a8763a 月台箱；#161d2f 同 v1/2）
    const acc14=[
      '34,90','35,90','36,90','37,90','34,91','35,91','36,91','37,91','34,92','35,92','36,92','37,92','34,93','35,93','36,93','37,93',
      '26,106','27,106','28,106','29,106','32,106','33,106','34,106','35,106','38,106','39,106','40,106','41,106','44,106','45,106','46,106','47,106',
      '15,84','16,84','18,84','52,85','53,85','55,85','22,88','23,88','25,88','45,88','46,88','48,88','29,91','30,91','41,92',
    ...
    beacon421['15_1_1']=acc12.slice();beacon421['15_1_2']=acc12.slice();
    beacon421['15_1_3']=acc13.slice();beacon421['15_1_4']=acc14.slice();
    ...
    // G5 rect 表（四鍵同構；__t421Replay 量測貼上）
    const oneRect421=[{x:33,y:96,w:2,h:8},{x:37,y:96,w:1,h:8},{x:32,y:94,w:8,h:1},{x:32,y:95,w:7,h:1},{x:21,y:108,w:5,h:1},{x:45,y:108,w:5,h:1}];
    const rectTable421={'15_1_1':oneRect421,'15_1_2':oneRect421,'15_1_3':oneRect421,'15_1_4':oneRect421};
    ...
    assert(ink421&&ink421.rects===24&&ink421.px===196,
      'T421 G5 計數：__t421Ink 恰等 rects=24／px=196（四鍵×6 rect／49 px）');
    ...
    assert(ink421.rects===24&&ink421.px===196,
      'T421 G6 落筆恆等：rects=24／px=196（空骨架或多畫即紅，實得 '+JSON.stringify(ink421)+'）');
  }
