...
runPwaTests().then(() => {
  ...
  { // ===== T421 ART-LOOP 守衛（獨立受管區；訊息只具名 T421） =====
    ...
    assert(m421['15_1_1']&&m421['15_1_1'].w===72&&m421['15_1_1'].h===112&&m421['15_1_1'].ax===36&&m421['15_1_1'].ay===110
      ...
      &&m421['15_1_3']&&m421['15_1_3'].w===72&&m421['15_1_3'].h===112&&m421['15_1_3'].ax===36&&m421['15_1_3'].ay===110
      &&m421['15_1_4']&&m421['15_1_4'].w===72&&m421['15_1_4'].h===112&&m421['15_1_4'].ax===36&&m421['15_1_4'].ay===110
      &&m421['14_1_1']&&m421['14_1_1'].w===72&&m421['14_1_1'].h===112&&m421['14_1_1'].ax===36&&m421['14_1_1'].ay===110
      &&m421['14_1_2']&&m421['14_1_2'].w===72&&m421['14_1_2'].h===112&&m421['14_1_2'].ax===36&&m421['14_1_2'].ay===110,
      'T421 G2 metadata 恆等：15_1_1..4／14_1_1..2 record w72/h112/ax36/ay110');
    const wl421=['15_1_1','15_1_2','15_1_3','15_1_4','14_1_1','14_1_2'];
    ...
    assert(rp421['15_1_1'].ops>=6&&rp421['15_1_2'].ops>=6&&rp421['15_1_3'].ops>=6&&rp421['15_1_4'].ops>=6
      &&rp421['14_1_1'].ops>=8&&rp421['14_1_2'].ops>=8
      &&rp421['15_1_1'].ink>=49&&rp421['14_1_1'].ink>=43,
      'T421 G3 落筆觀測：15 ops≥6/ink≥49；14 ops≥8/ink≥43，實得 '+JSON.stringify(Object.fromEntries(wl421.map(k=>[k,rp421[k].ops+':'+rp421[k].ink]))));
    // G4 beacons：量測貼上（15 見 R01/R02；14 見 R03 geom；29 見 T420 紅桶燈＋豎管）
    const beacon421={};
    const acc15_12=[
      ...
      '17,84','54,85','24,88','47,88','31,91','40,92','17,87','54,88','24,91','47,91','31,94','40,95',
      '22,101','23,101','24,101','46,101','47,101','48,101','36,105','36,106','36,107','20,101','37,108','59,97','43,105'
    ];
    const acc15_3=[
      '26,106','27,106','28,106','29,106','32,106','33,106','34,106','35,106','38,106','39,106','40,106','41,106','44,106','45,106','46,106','47,106',
      '10,90','61,90','8,91','9,91','62,91','63,91','6,92','7,92','64,92','65,92','4,93','5,93','66,93','67,93',
      '28,104','29,104','30,104','31,104','32,104','28,105','29,105','30,105','31,105','32,105','30,106','31,106',
      '36,96','36,97','36,98','36,99','36,100','36,101','36,102','36,103','36,104',
      '53,96','54,96','55,96','47,99','48,99','39,103','40,103','41,103',
      '15,95','16,95','22,99','23,99','24,99','29,102','30,102',
      '17,88','54,89','24,92','47,92','31,95','40,96','17,91','54,92','24,95','47,95','31,98','40,99',
      '22,101','23,101','24,101','46,101','47,101','48,101','17,95','18,95','25,99','31,102','32,102',
      '52,96','45,99','46,99','38,103','36,105','36,106','36,107','10,93','37,108','61,93'
    ];
    const acc15_4=[
      '34,90','35,90','36,90','37,90','34,91','35,91','36,91','37,91','34,92','35,92','36,92','37,92','34,93','35,93','36,93','37,93',
      '26,106','27,106','28,106','29,106','32,106','33,106','34,106','35,106','38,106','39,106','40,106','41,106','44,106','45,106','46,106','47,106',
      ...
      '15,91','16,91','17,91','18,91','22,95','23,95','24,95','25,95','29,98','30,98','31,98','32,98',
      '52,92','53,92','54,92','55,92','45,95','46,95','47,95','48,95','38,99','39,99','40,99','41,99',
      '47,97','48,97','49,97','50,97','47,98','48,98','49,98','50,98','47,99','48,99','49,99','50,99',
      '8,91','63,91','6,92','7,92','64,92','65,92','4,93','5,93','66,93','67,93',
      '36,96','36,97','36,98','36,99','36,100','36,101','36,102','36,103','36,104',
      '17,84','54,85','24,88','47,88','31,91','40,92','17,87','54,88','24,91','47,91','31,94','40,95',
      '22,101','23,101','24,101','46,101','47,101','48,101','36,105','36,106','36,107'
    ];
    // 14_1_1/2 geom 量測 ≤16px
    const acc14=[
      '32,108','33,108','34,108','35,108','36,108','37,108','38,108','39,108','32,109','33,109','34,109','35,109','36,109','37,109','38,109','39,109',
      '36,90','36,91','36,92','36,93','36,94','36,95','36,96','36,97','36,98','36,99','36,100','36,101','36,102','36,103','36,104',
      '22,100','23,100','24,100','22,101','23,101','24,101','22,102','23,102','24,102','22,103','23,103','24,103','22,104','23,104','24,104',
      '26,100','27,100','28,100','26,101','27,101','28,101','26,102','27,102','28,102','26,103','27,103','28,103','26,104','27,104','28,104',
      '10,90','61,90','8,91','9,91','62,91','63,91','6,92','7,92','64,92','65,92','4,93','5,93','66,93','67,93',
      '32,106','33,106','38,106','39,106','31,107','32,107','33,107','34,107','35,107','36,107','37,107','38,107','39,107','40,107',
      '15,91','16,91','17,91','18,91','22,95','23,95','24,95','25,95','29,98','30,98','31,98','32,98',
      '52,92','53,92','54,92','55,92','45,95','46,95','47,95','48,95','38,99','39,99','40,99','41,99',
      '28,106','29,106','30,106','31,106','34,106','35,106','36,106','37,106','40,106','41,106','42,106','43,106',
      '17,84','54,85','24,88','47,88','31,91','40,92','17,87','54,88','24,91','47,91','31,94','40,95',
      '36,105','61,91'
    ];
    beacon421['15_1_1']=acc15_12.slice();beacon421['15_1_2']=acc15_12.slice();
    beacon421['15_1_3']=acc15_3.slice();beacon421['15_1_4']=acc15_4.slice();
    beacon421['14_1_1']=acc14.slice();beacon421['14_1_2']=acc14.slice();
    ...
    const rectPost=[{x:33,y:96,w:2,h:8},{x:37,y:96,w:1,h:8},{x:32,y:94,w:8,h:1},{x:32,y:95,w:7,h:1},{x:21,y:108,w:5,h:1},{x:45,y:108,w:5,h:1}];
    const rectLib=[{x:33,y:96,w:2,h:8},{x:37,y:96,w:1,h:8},{x:32,y:94,w:3,h:1},{x:37,y:94,w:3,h:1},{x:32,y:95,w:3,h:1},{x:37,y:95,w:2,h:1},{x:21,y:105,w:4,h:1},{x:25,y:105,w:4,h:1}];
    const rectTable421={
      '15_1_1':rectPost,'15_1_2':rectPost,'15_1_3':rectPost,'15_1_4':rectPost,
      '14_1_1':rectLib,'14_1_2':rectLib
    };
    ...
    // 4*6 post + 2*6 lib + 2*5 rec = 24+12+10 = 46 rects; px 4*49+2*47+2*24 = 196+94+48 = 338
    assert(ink421&&ink421.rects===40&&ink421.px===282,
      'T421 G5 計數：__t421Ink 恰等 rects=40／px=282（15×4 +14×2 +29×2）');
    ...
    for(const r of rects421src){
      ...
      const xm=r[0].match(/sp(?:15b|14b)\.ax([+-]\d+)/);
      const ym=r[1].match(/sp(?:15b|14b)\.ay([+-]\d+)/);
    ...
    assert(ink421.rects===40&&ink421.px===282,
      'T421 G6 落筆恆等：rects=40／px=282（空骨架或多畫即紅，實得 '+JSON.stringify(ink421)+'）');
  }
