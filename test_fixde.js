...
assert(/const CACHE=CACHE_PREFIX\+'v13';/.test(swSrc), 'sw.js CACHE 應由專屬前綴組成 v13');
...
async function runPwaTests() {
  ...
  assert(h268.ops.opened[0] === 'glimmerville-shell-v13',
    'T268-T270 install 應開啟目前專屬 glimmerville-shell-v13 cache');
  ...
  assert(keys268.includes('glimmerville-shell-v13') && keys268.includes('gv-other-app') && keys268.includes('shared-cache'),
  ...
  await h268.cacheStorage.delete('glimmerville-shell-v13');
  h268.setFetch(async () => { throw new TypeError('offline'); });
  result268 = await h268.fireFetch({ method: 'GET', url: base268, mode: 'navigate' });
  ...
  assert(h269.ops.opened[0] === 'glimmerville-shell-v13' &&
  ...
  assert(!keys269.includes('glimmerville-shell-v3') && !keys269.includes('glimmerville-shell-v4') &&
    keys269.includes('glimmerville-shell-v13') &&
  ...
  const cache269 = await h269.cacheStorage.open('glimmerville-shell-v13');
  ...
  await h269.cacheStorage.delete('glimmerville-shell-v13');
  result269 = await h269.fireFetch({
  ...
  await h271Miss.cacheStorage.delete('glimmerville-shell-v13');
