...
const SV = [ // [tool, k, sz]；T226/T230/T232：farm/ranch/parking 擴變體移出單變體清單；T228：新增 bigFarm 5×5
  ['airport', 19, 4],
  ['solar', 25, 2], ['prison', 31, 2], ['university', 32, 3], ['bigFarm', 53, 5], ['bigCemetery', 54, 3], ['grandStation', 55, 3]
];
const svRoots = [];
...
const SVK = new Set([19, 25, 31, 32, 53, 54, 55]); // T228/T233/T234：bigFarm/bigCemetery/grandStation 亦屬單變體；T230/T232：ranch/parking 移出
let tampered = 0;
