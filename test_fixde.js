...
assert(/const CACHE=CACHE_PREFIX\+'v20';/.test(swSrc), 'sw.js CACHE 應由專屬前綴組成 v20');
...
async function runPwaTests() {
  ...
  assert(h268.ops.opened[0] === 'glimmerville-shell-v20',
    'T268-T270 install 應開啟目前專屬 glimmerville-shell-v20 cache');
  ...
  assert(keys268.includes('glimmerville-shell-v20') && keys268.includes('gv-other-app') && keys268.includes('shared-cache'),
  ...
  await h268.cacheStorage.delete('glimmerville-shell-v20');
  h268.setFetch(async () => { throw new TypeError('offline'); });
  result268 = await h268.fireFetch({ method: 'GET', url: base268, mode: 'navigate' });
  ...
  assert(h269.ops.opened[0] === 'glimmerville-shell-v20' &&
  ...
  assert(!keys269.includes('glimmerville-shell-v3') && !keys269.includes('glimmerville-shell-v4') &&
    keys269.includes('glimmerville-shell-v20') &&
  ...
  const cache269 = await h269.cacheStorage.open('glimmerville-shell-v20');
  ...
  await h269.cacheStorage.delete('glimmerville-shell-v20');
  result269 = await h269.fireFetch({
  ...
  await h271Miss.cacheStorage.delete('glimmerville-shell-v20');
